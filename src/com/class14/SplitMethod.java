...
public class SplitMethod {
	...
	public static void main(String[] args) {
		...
		String str1="Today is Sunday. Its sunnuy day. and we are having java class";
		String[] array1=str1.split("\\.");
		System.out.println("The number of the sentences in the given String is: "+array1.length);
